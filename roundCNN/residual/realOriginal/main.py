...
from torchvision.models import wide_resnet50_2, resnet18, efficientnet_v2_m
...
def parse_args():
    ...
    parser.add_argument('-d', '--data_path', type=str, default="C:/Users/sertac/Desktop/realOriginal/mvtec_anomaly_detection")
