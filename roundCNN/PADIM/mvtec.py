...
class MVTecDataset(Dataset):
    def __init__(self, dataset_path='E:/Github_Repos/Defect-Detection-With-Robotic-Arm/roundCNN/PADIM/mvtec_anomaly_detection', class_name='bottle', is_train=True,
